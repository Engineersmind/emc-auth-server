...
ALTER TABLE refresh_tokens
    ADD COLUMN IF NOT EXISTS session_family_id BIGINT,
...
-- Each existing row seeds its own session family from its own PK.
UPDATE refresh_tokens SET session_family_id = id WHERE session_family_id IS NULL;
