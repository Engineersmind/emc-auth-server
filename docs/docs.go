...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/auth.ProviderConfigDetail"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/v1/applications/{appID}/identity-providers/{provider}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpsertProviderConfigRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/applications/{appID}/roles/{id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "New role name (permission_ids ignored)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/applications/{appID}/roles/{id}/default": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/auth.MFAStatus"
                        }
                    }
                }
            }
        ...
        "/api/v1/auth/oauth/exchange": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "client_id + login_code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/auth/session/mfa/enroll/activate": {
            "post": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    {
                        "description": "Enrollment token and first code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.SessionMFAActivateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.SessionMFAVerifyRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "401": {
                        "description": "mfa_code_invalid or mfa_session_expired",
                        "schema": {
        ...
        "/api/v1/platform/admin-mfa-policy": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/admin.AdminMFAPolicyView"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.AdminMFAPolicyInput"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.SigningKeyListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/v1/tenants": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by status: active | inactive | suspended (suspended maps to inactive)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "integer",
                        "description": "Rows per page (default 25, max 100); alias: limit",
                        "name": "per_page",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/admin.CreateTenantResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/tenants/{id}/cors-origins": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/tenants/{tid}/admin-mfa-policy": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/tenants/{tid}/admins/{adminID}/mfa": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "mfa_reset_forbidden",
                        "schema": {
                            "$ref": "#/definitions/handlers.APIError"
                        }
                    },
        ...
        "/api/v1/tenants/{tid}/applications/{appID}/rate-limit": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/tenants/{tid}/roles/{rid}/permissions": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/admin.UserDetail"
                        }
                    },
                    "404": {
                        "description": "Not Found",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/auth.UserIdentityDetail"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/v1/users/{id}/identities/{provider}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                    ...
                    "200": {
                        ...
                        "schema": {
                            ...
                            "additionalProperties": {
                                "type": "array",
                                "items": {
                                    "$ref": "#/definitions/admin.UserSession"
                                }
                            }
                        }
                    },
        ...
        "/api/v1/users/{id}/sessions/{familyID}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.SetUserStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/oauth/authorize": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Registered client_id",
                        "name": "client_id",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Must exactly match a registered redirect_uri. Optional only when exactly one is registered.",
                        "name": "redirect_uri",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Space-delimited. Unregistered scopes are dropped, not rejected.",
                        "name": "scope",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "OIDC nonce, echoed into the ID token",
                        "name": "nonce",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "HTML error page — client_id or redirect_uri invalid"
                    }
                }
            }
        },
        "/oauth/revoke": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "refresh_token | access_token",
                        "name": "token_type_hint",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "Required — prefer the Authorization Basic header",
                        "name": "client_id",
                        "in": "formData",
                        "required": true
                    },
                ...
                "responses": {
                    "200": {
                        "description": "Token revoked, or did not exist"
                    },
                    "401": {
                        "description": "client authentication failed",
                        "schema": {
                            "$ref": "#/definitions/handlers.tokenError"
                        }
                    }
                }
            }
        ...
        "/oauth/token": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Must match the value the code was issued against",
                        "name": "redirect_uri",
                        "in": "formData"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Confidential clients — prefer the Authorization Basic header",
                        "name": "client_secret",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "client_credentials only",
                        "name": "scope",
                        "in": "formData"
                    }
                ],
        ...
        "/oauth/{provider}/callback": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Opaque state issued at login start",
                        "name": "state",
                        "in": "query",
                        "required": true
                    },
        ...
        "/oauth/{provider}/login": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Post-login redirect target (must be in the application's allow-list; optional when the list has exactly one entry)",
                        "name": "redirect",
                        "in": "query"
                    }
                ],
        ...
        "/tenants/{slug}/.well-known/jwks.json": {
            "get": {
        ...
        "/tenants/{slug}/.well-known/openid-configuration": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.OIDCDiscoveryDocument"
                        }
                    },
                    "304": {
                        "description": "Not Modified — document unchanged since the supplied ETag"
                    },
                    "404": {
                        "description": "Not Found",
                        "schema": {
    ...
    "definitions": {
        ...
        "admin.AdminMFAPolicyView": {
            ...
            "properties": {
                ...
                "inherited": {
                    "description": "Inherited is true when the tenant has no row of its own and the values\ncame from the platform policy.",
                    "type": "boolean"
                },
                "mfa_required": {
                    "description": "MFARequired is always true. Reported so a client never has to assume it.",
                    "type": "boolean"
                },
                "scope": {
                    "description": "Scope is \"platform\" or \"tenant\" — which row answered the request.",
                    "type": "string"
                },
                "supported_methods": {
                    "description": "SupportedMethods is every method a policy may name.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "admin.CreateTenantResult": {
            ...
            "properties": {
                "owner": {
                    "$ref": "#/definitions/admin.OwnerResult"
                },
                "tenant": {
                    "$ref": "#/definitions/admin.TenantResult"
                }
        ...
        "admin.UserDetail": {
            ...
            "properties": {
                ...
                "identities": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/admin.UserIdentity"
                    }
                },
                "is_active": {
                    "type": "boolean"
                ...
                "last_login_at": {
                    "description": "LastLoginAt is the most recent session activity (Auth0's \"Latest Login\").",
                    "type": "string"
                },
                "last_name": {
                    "type": "string"
        ...
        "auth.MFAMethodStatus": {
            "type": "object",
            "properties": {
                "active": {
                    "description": "Active: the caller has it enrolled.",
                    "type": "boolean"
                },
                "allowed": {
                ...
                "backup_codes_remaining": {
                    "description": "BackupCodesRemaining is the number of unused backup codes (totp only).",
                    "type": "integer"
                },
                "method": {
                    "type": "string"
        ...
        "auth.MFAStatus": {
            ...
            "properties": {
                "methods": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/auth.MFAMethodStatus"
                    }
                },
                "mfa_required": {
                    "description": "MFARequired is true when the caller is an administrator and MFA is\ntherefore mandatory for them.",
                    "type": "boolean"
                },
                "policy_source": {
                    "type": "string"
        ...
        "handlers.APIError": {
            ...
            "properties": {
                "error": {
                    "description": "Error is the stable machine code. Clients switch on this.",
                    "type": "string"
                },
                "message": {
                    "description": "Message is prose for the person who hit the failure. Never parse it.",
                    "type": "string"
                }
            }
        },
        ...
        "handlers.CreateApplicationRequest": {
            ...
            "properties": {
                ...
                "require_pkce": {
                    "description": "RequirePKCE defaults to true when omitted. Pointer so \"omitted\" is\ndistinguishable from an explicit false.",
                    "type": "boolean"
                },
                "scopes": {
                    "description": "Scopes accepts resource:action permission strings and the reserved OIDC\nscopes (openid, profile, email, offline_access). Optional.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "handlers.OIDCDiscoveryDocument": {
            "type": "object",
            "properties": {
        ...
        "handlers.SessionMFAActivateRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "handlers.SessionMFAVerifyRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "handlers.SigningKeyListResponse": {
            "type": "object",
            "properties": {
                "jwks_url": {
                    "description": "JWKSURL is where verifiers should fetch these keys. Returned so an operator\nnever has to construct it by hand or guess the scheme.",
                    "type": "string"
                },
                "keys": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.SigningKeyInfo"
                    }
                }
            }
        },
        ...
        "handlers.UpdateApplicationRequest": {
            ...
            "properties": {
                ...
                "redirect_uris": {
                    "description": "RedirectURIs omitted = unchanged; [] clears — same convention as Scopes.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "require_pkce": {
                    "description": "Nil leaves the flag unchanged.",
                    "type": "boolean"
                },
                "scopes": {
                    "type": "array",
        ...
        "handlers.UpsertProviderConfigRequest": {
            "type": "object",
            "properties": {
                "client_id": {
                    "type": "string"
